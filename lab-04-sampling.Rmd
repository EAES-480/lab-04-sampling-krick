...
|----------|-------|-------------|----------------------------|
|  fc      | µmolCO2 m-2 s-1 | Carbon Dioxide (CO2) turbulent flux |                            |
|  le      | W m-2 | Latent heat turbulent flux |                           |
...
> The SRS strategy better aproximated the population mean and SD for my response variable. Stratifcation by month may not have helped here because while the variation in `gpp` is affected by seasonal cycles, it is also greatly affected by cycles of day and night. 
...
> Systematic sampling approximated the population mean worse than SRS. The daily cycle might be interacting with my chosen `k`. 
